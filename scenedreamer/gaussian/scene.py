...
from scenedreamer.geometry.array_ops import (
    dpt2xyz,
    alpha_inpaint_mask,
    transform_points,
    numpy_normalize,
...
class GaussianScene():
    def __init__(self,cfg=None):
        ...
        self.frames = []
        self.gaussian_frames: list[GaussianFrame] = [] # gaussian frame require training at this optimization
        # activate fuctions
    ...
    def _add_trainable_frame(self,frame:Frame,require_grad=True):
        ...
        gf = GaussianFrame(frame, self.device)
